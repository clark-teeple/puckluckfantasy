...
const teamColorMapping = {
  ...
  'Colorado Avalanche': { primary: '#A2AAAD', secondary: '#236192', background: '#6F263D', text: 'white'},
  ...
  'Boston Bruins': { primary: 'black', secondary: 'white', background: '#FFB81C'},
  ...
  'Columbus Blue Jackets': { primary: '#A4A9AD', secondary: '#CE1126', background: '#002654', text: 'white'},
